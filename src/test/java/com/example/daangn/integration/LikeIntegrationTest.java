...
//            post1.setId(postRepository.findOneByUsername(user1.getUsername()));
//
//            //when
...
//            assertNotNull(resultDto);
//            assertTrue(resultDto.response);
//            assertEquals(resultDto.username, user2.getUsername());
//            assertEquals(resultDto.nickname, user2.getNickname());
//
//            //user1의 토큰을 담아둠
//            user2Token = resultDto.token;
//        }
//
//
//        @Test
//        @Order(7)
//        @DisplayName("유저2의 게시물1 좋아요")
//        void test7() throws JsonProcessingException {
//            // given
//            headers.set("Authorization", user2Token);
//            HttpEntity<String> request = new HttpEntity<>("", headers);
//
//            //when
//            ResponseEntity<ResultDto> response = restTemplate.postForEntity(
...
//            assertNotNull(resultDto);
//            assertTrue(resultDto.response);
//            assertEquals(resultDto.message, "관심목록에 추가성공");
//
//            Like like = likeRepository.findOneByUsername(user2.getUsername());
//            assertEquals(like.getPost().getId(),post1.id);
//        }
//
//    @Getter
//    @Setter
...
//        private PostIntegrationTest.PostResponseDto post;
//    }
//    @Getter
//    @Setter
//    @Builder
